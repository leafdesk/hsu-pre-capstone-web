    ...
    <div className="max-w-7xl mx-auto py-6 px-6">
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="space-y-4">
          <h3 className="font-medium text-gray-700 mb-2">{displayName}님에 대한 상세 피드백</h3>
          <div className="bg-gray-100 p-6 rounded-lg shadow-sm">
            ...
            <p className="text-gray-700">
              {displayName}님에 대한 상세 피드백입니다. <br></br>회의 중 {displayName}님의 발언 및 성과에 대한 구체적인 데이터와 차트, 인사이트를 제공하여 종합적인 내용을 보여줄 수 있습니다.
            </p>
          </div>
        </div>
